...
const int   C_NUM_LEDS =          60;     // This is the number of LEDs in the light strip
...
const bool C_InputConfig[LED_ModeSz][InputChanSz] = 
  ...
  /* InputChan0 InputChan1 InputChan2 InputChan3 */
   ...
   { true,      false,     false,     false }, /* Mode8  */
   { true,      false,     false,     true  }, /* Mode9  */
   { true,      false,     true,      false }, /* Mode10 */
   { true,      false,     true,      true  }, /* Mode11 */
   { true,      true,      false,     false }, /* Mode12 */
   { true,      true,      false,     true  }, /* Mode13 */
   { true,      true,      true,      false }, /* Mode14 */
   { true,      true,      true,      true  }  /* Mode15 */
  };
...
const int K_LightSettings[LED_ModeSz][LED_ConfigSz] =
  ...
  /* Color                   Fade   HalfOn   Trace */
   { int(LED_Color_Duo),      0,      0,       1 }, /* Mode0 - This should remain the default/off condition */
   ...
   { int(LED_Color_Yellow),   1,      0,       0 }, /*Mode 8*/
   { int(LED_Color_Green),    0,      1,       1 }, /*Mode 9*/
   { int(LED_Color_Green),    1,      0,       0 }, /*Mode 10*/
   { int(LED_Color_Pink),     1,      1,       0 }, /* Mode 11 */
   { int(LED_Color_Rainbow),  1,      0,       0 }, /*Mode 12*/
   { int(LED_Color_Orange),   1,      0,       0 }, /*Mode 13*/
   { int(LED_Color_White),    1,      0,       0 }, /*Mode 14*/
